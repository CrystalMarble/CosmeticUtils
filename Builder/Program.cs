...
internal class Builder
{
    ...
    public static Config PromptForConfig()
    {
        ...
        if (!Path.Exists(Path.Combine(UltraPath, "Mods", "CosmeticUtils"))) Directory.CreateDirectory(Path.Combine(UltraPath, "Mods", "CosmeticUtils"));
        config.ModDirectory = Path.Combine(UltraPath, "Mods", "CosmeticUtils");
        return config;
    }
    ...
    public static string Build()
    {
        ...
        CopyDeps();
        Directory.SetCurrentDirectory("../../../../CosmeticUtils");
        Console.WriteLine("Building CosmeticUtils...");
        ...
        var ModPath = Path.Combine(Directory.GetCurrentDirectory(), "bin", "Debug", "CosmeticUtils.dll");
        Console.WriteLine($"CosmeticUtils is available at {ModPath}");
        return ModPath;
    }
    ...
    private static void Main(string[] args)
    {
        ...
        Console.WriteLine("Installing CosmeticUtils to Marble it Up! Ultra...");
        File.Copy(LoaderPath, Path.Combine(config.ModDirectory, "CosmeticUtils.dll"), true);
        Console.WriteLine("Successfully installed CosmeticUtils.dll to Marble it Up! Ultra");
    }
